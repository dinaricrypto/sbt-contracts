...
contract ForwarderPythTest is Test {
    ...
    ForwarderPyth public forwarder;
    ...
    address constant pythContract = 0xff1a0f4744e8582DF1aE09D5611b887B6a12925C;
    bytes32 constant ethUsdPriceOracleId = 0xff61491a931112ddf1bd8147cd1b641375f79f5825126d665480874634fd0ace;
    bytes32 constant usdcPriceOracleId = 0xeaa020c61cc479712813461ce153894a96a6c00b21ed0cfc2798d1f9a9e9c94a;
    ...
    function setUp() public {
        ...
        forwarder = new ForwarderPyth(pythContract, ethUsdPriceOracleId, SELL_GAS_COST);
        ...
        vm.prank(owner);
        forwarder.setPaymentOracle(address(paymentToken), usdcPriceOracleId);
    }

    function testUpdatePythContract(address _pythContract) public {
        vm.expectRevert(abi.encodeWithSelector(Ownable.OwnableUnauthorizedAccount.selector, address(this)));
        forwarder.setPythContract(_pythContract);
    ...
    function testUpdateEthOracle(bytes32 _oracle) public {
        vm.expectRevert(abi.encodeWithSelector(Ownable.OwnableUnauthorizedAccount.selector, address(this)));
    ...
    function testUpdateOracle(address _paymentToken, bytes32 _oracle) public {
        vm.expectRevert(abi.encodeWithSelector(Ownable.OwnableUnauthorizedAccount.selector, address(this)));
    ...
    function _getPaymentPriceInWei() internal view returns (uint256) {
        bytes32 _oracle = usdcPriceOracleId;
        PythStructs.Price memory paymentPriceInfo = IPyth(pythContract).getPriceUnsafe(_oracle);
        int256 paymentPrice = paymentPriceInfo.price;
        PythStructs.Price memory ethUSDPriceInfo = IPyth(pythContract).getPriceUnsafe(ethUsdPriceOracleId);
