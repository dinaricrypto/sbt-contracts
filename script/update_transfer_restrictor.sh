#!/bin/bash
# Executes the UpdateTransferRestrictorForDShareFactory script on the specified RPC URL
#
...
echo "========================"
echo "UpdateTransferRestrictorForDShareFactory: Executing"

# Base Forge command without the environment variable inline
FORGE_CMD="forge script script/UpdateTransferRestrictorForDShareFactory.s.sol -vvv --rpc-url $RPC_URL --private-key $PRIVATE_KEY --slow"
