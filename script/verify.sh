...
# no args
forge verify-contract --chain-id 98865 --verifier blockscout --watch 0x57bEe36C8BC933F06e3176bEb386Ea234B8535ae src/plume-nest/DinariAdapterToken.sol:DinariAdapterToken
